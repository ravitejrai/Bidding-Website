...
public class DeleteItemService {
	...
	public Response addNewUser(String data,String data1) 
	{
		...
		ArrayList<ArrayList<String>> searchResult = DBOperation.deleteItem(title, username);
		System.out.println("The search result in DeleteItemServlet is: " + searchResult);
